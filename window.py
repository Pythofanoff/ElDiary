...
# Перевести диалог. окно в отдельный класс 
...
class MainWindow(tk.Frame):
    ...
    def init_filters(self):
        ...
        ttk.Button(self.filter_frame, text='Добавить студента(ов)...', command=self.add_students).pack(padx=(3,2), anchor='e', side='left')
    ...
    def get_discipline(self, event=None):
        ...
        # Если пользователь выбрал изменение дисциплины
            ...
            def edit_discipline(event=None):  
                ...
                if not new:
                    messagebox.showerror('Ошибка', 'Поле названия пустое', parent=dialog)
                    return 
        ...
        # Если пользователь выбрал добавление дисциплины
            ...
            def save_disciplines(event=None):  
                ...
                if not new:
                    messagebox.showerror('Ошибка', 'Поле дисциплины пустое', parent=dialog)
                    return
    ...
    def init_tree(self):
        ...
        # Treeview - 1 ()
        self.discipline: list = [self.discipline_selected if self.discipline_selected != 'Добавить дисциплину...' else 'Дисциплина не выбрана']
